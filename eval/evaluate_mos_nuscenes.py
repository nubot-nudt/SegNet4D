...
if __name__ == '__main__':
  ...
  parser.add_argument(
      ...
      type=str,
      required=False,
      default="config/nuscenes/nuscenes_all_mos.yaml",
  ...
  for sequence in test_sequences:
    ...
    seq_pred_names.sort()
    # seq_pred_names = seq_pred_names[2:]
    pred_names.extend(seq_pred_names)
    # pred_names = pred_names[5:]
  ...
  for label_file, pred_file in zip(label_names[:], pred_names[:]):
    ...
    # print("predict label:",len(pred[pred==2]))
